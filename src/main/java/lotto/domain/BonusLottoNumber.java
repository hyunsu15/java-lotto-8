...
public class BonusLottoNumber {
    private static final String ILLEGAL_NUMBER_ERROR_MESSAGE = "보너스 넘버도 1-45사이여야합니다. 현재값 :%d";
    ...
    private void validate(int lottoNumber) {
        if (lottoNumber < Lotto.MIN_NUMBER || lottoNumber > Lotto.MAX_NUMBER) {
            throw new IllegalArgumentException(ILLEGAL_NUMBER_ERROR_MESSAGE.formatted(lottoNumber));
        }
    }
